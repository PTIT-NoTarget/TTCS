...
if section == "1":
  ...
  print(f'15. Merge two ordered singly linked lists of integers into one ordered list: {n}-node list = ', end="")
  llist.printList(0)
  ...
  for _ in input().split():
    llist2.addToTail(int(_))
  print(f'17. Attach a singly linked list of {n2} elements ', end="")
  llist2.printList(0)
  print(f' to the end of another singly linked list of {n} nodes: ', end="")
  llist.printList()
  llist.attach(llist2)
  llist.printList()
elif section == "18":
  ...
  for _ in input().split():
    llist.addToTail(int(_))
  print(f'24. Reverse the singly linked list of {n} nodes: ', end="")
  llist.printList()
  llist.reverse()
  llist.printList()
elif section == "25":
  ...
  for _ in input().split():
    llist2.addToTail(int(_))
  print(f'25. Check whether two singly linked list have the same contents: 1st list of {n} elements: ', end="")
  llist.printList(0)
